...
INSERT INTO "new_Order" ("buyerId", "commissionAmount", "createdAt", "id", "quoteId", "rfqId", "sellerId", "status", "totalAmount") SELECT "buyerId", "commissionAmount", "createdAt", "id", "quoteId", "rfqId", "sellerId", "status", "totalAmount" FROM "Order";
DROP TABLE "Order";
