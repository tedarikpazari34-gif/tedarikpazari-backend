...
const localePath =
  '../../tedarikci-frontend/src/i18n/locales/ru.ts';
...
JSON değerlerini Türkçeden doğal ve profesyonel Rusçaya çevir.
...
console.log(`Tamamlandı: ${entries.length} metin Rusçaya çevrildi.`);
