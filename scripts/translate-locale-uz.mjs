...
const localePath =
  '../../tedarikci-frontend/src/i18n/locales/uz.ts';
...
JSON değerlerini Arapçadan doğal ve profesyonel Özbekçeye çevir.
...
console.log(`Tamamlandı: ${entries.length} metin Özbekçeye çevrildi.`);
