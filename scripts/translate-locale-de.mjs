...
const localePath =
  '../../tedarikci-frontend/src/i18n/locales/de.ts';
...
JSON değerlerini Rusçadan doğal ve profesyonel Almancaya çevir.
...
console.log(`Tamamlandı: ${entries.length} metin Almancaya çevrildi.`);
