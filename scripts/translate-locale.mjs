...
const localePath =
  '../../tedarikci-frontend/src/i18n/locales/ka.ts';
...
JSON değerlerini Türkçeden doğal ve profesyonel Gürcüceye çevir.
...
console.log(`Tamamlandı: ${entries.length} metin Gürcüceye çevrildi.`);
